...
`spill/assets/traaler-reke-hal.png` — Reketrålaren PÅ HAL, sett frå sida (1022 tegn):

Den som alt ligger der (`traaler-reke.png`) er båten i ro — dette er same båt i arbeid, med trålen ute og fiskaren ute på dekk ved styringa. Merk: her er det ikkje måla sjø i biletet. Nota heng bak og ned frå gantryet, så spelet kan setje henne på vasslinja og la nota stå under overflata, slik alt anna under vatn blir teikna.

> Retro video game pixel art style. A single game sprite seen from the side: a working Norwegian shrimp trawler under way with her gear shot away. Blue steel hull with a high bow pushing a small white wash, white superstructure aft, radar and antennas on the wheelhouse roof, a wisp of exhaust from the funnel. Two tall outrigger booms angled down and out, and trawl wires running from a stern gantry back and downward to a long green mesh net that streams out behind and below her, floats along its top edge, the bag swelling at the far end. A fisherman in orange oilskins stands outside on the open aft deck at a small control pedestal, both hands on the levers, watching the gear astern. Chunky and readable at small size: few large details, thick clean pixel outlines, slight warm shading. Centred, filling most of the frame. The entire background is flat solid magenta, one single colour, completely empty; nothing touches the image edge. Strict pixel grid, hard-edged pixels, no anti-aliasing, no text, no drop shadow.

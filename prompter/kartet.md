...
### Saltvær med verkstadet (6. aug) — heile øya i eitt bilete

Eigaren ville ha verkstadet med i sjølve landsby-biletet i staden for som eige motiv:
slipp rett ned i sjøen og vinsj til småbåtar, nede ved hamna. Butikken, det høge huset,
det raude naustet og katten er framleis med. (1009 tegn)

> Retro video game pixel art style. High three-quarter aerial view with depth and elevation. Warm golden northern light from the upper left, long soft shadows. A small Norwegian island village: at the water's edge a boat workshop with open doors, a timber slipway running from them into the sea, a winch with a steel drum at the top and a small boat halfway up the rails. Beside it a red boathouse and a stone pier with a fishing boat moored. Up the slope a bait shop with a hanging fish sign, a tall old house, homes with grass roofs, smoke from two chimneys, drying racks, laundry, gulls, and a cat asleep on a rock. Densely detailed, warm and lived-in, no purple or pink cast. An irregular organic natural form — no square base, no diorama tile. Only a narrow band of water and white foam hugs the island; beyond the foam the background is flat solid magenta on all four sides, one colour, completely empty, and nothing touches the image edge. Strict pixel grid, hard-edged pixels, no anti-aliasing, no text.

...
a, b = dorer[FILER[0]], dorer[FILER[1]]
print("døra er %d tegn, funnet i begge filene." % len(a))
...
print("✓ identiske, og alle fire sjekkene (aud, iss, verifisert, allowlist) står")
